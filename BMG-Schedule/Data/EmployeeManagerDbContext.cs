...
namespace BMG_Schedule.Data
{
    public class EmployeeManagerDbContext : IdentityDbContext<IdentityUser<int>, IdentityRole<int>, int>
    {
        ...
        public override DbSet<IdentityRole<int>> Roles => Set<IdentityRole<int>>();
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Role>().HasData(
                new Role { Name = "User", NormalizedName = "USER", Id = 1, ConcurrencyStamp = Guid.NewGuid().ToString() },
                new Role { Name = "Administrator", NormalizedName = "ADMINISTRATOR", Id = 2, ConcurrencyStamp = Guid.NewGuid().ToString() }
                );
