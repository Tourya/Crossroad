    ...
    public class EmployeeManagerDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<WorkingDay>()
                ...
                new WorkingDay { Id = 9, Start = new DateTime(2023, 02, 01, 09, 00, 00), End = new DateTime(2023, 02, 01, 16, 50, 00), RecordTypeId = 1, EmployeeId = 1 },
                ...
                new WorkingDay { Id = 12, Start = new DateTime(2023, 02, 06, 09, 00, 00), End = new DateTime(2023, 02, 06, 17, 00, 00), RecordTypeId = 1, EmployeeId = 1 },
                new WorkingDay { Id = 13, Start = new DateTime(2023, 02, 07, 09, 00, 00), End = new DateTime(2023, 02, 07, 18, 30, 00), RecordTypeId = 1, EmployeeId = 1 },
                ...
                new WorkingDay { Id = 27, Start = new DateTime(2023, 02, 03, 09, 00, 00), End = new DateTime(2023, 02, 03, 18, 20, 00), RecordTypeId = 1, EmployeeId = 2 },
                ...
                new WorkingDay { Id = 35, Start = new DateTime(2022, 12, 19, 09, 00, 00), End = new DateTime(2022, 12, 19, 17, 45, 00), RecordTypeId = 1, EmployeeId = 3 },
                new WorkingDay { Id = 36, Start = new DateTime(2022, 12, 22, 09, 00, 00), End = new DateTime(2022, 12, 22, 17, 55, 00), RecordTypeId = 1, EmployeeId = 3 },
                new WorkingDay { Id = 37, Start = new DateTime(2023, 01, 26, 09, 00, 00), End = new DateTime(2023, 01, 26, 18, 30, 00), RecordTypeId = 1, EmployeeId = 3 },
                ...
                new WorkingDay { Id = 57, Start = new DateTime(2023, 02, 01, 09, 00, 00), End = new DateTime(2023, 02, 01, 17, 56, 00), RecordTypeId = 1, EmployeeId = 4 },
                ...
                new WorkingDay { Id = 60, Start = new DateTime(2023, 02, 06, 09, 00, 00), End = new DateTime(2023, 02, 06, 18, 13, 00), RecordTypeId = 1, EmployeeId = 4 },
                ...
                new WorkingDay { Id = 73, Start = new DateTime(2023, 02, 01, 09, 00, 00), End = new DateTime(2023, 02, 01, 18, 22, 00), RecordTypeId = 1, EmployeeId = 5 },
                new WorkingDay { Id = 74, Start = new DateTime(2023, 02, 02, 09, 00, 00), End = new DateTime(2023, 02, 02, 18, 09, 00), RecordTypeId = 1, EmployeeId = 5 },
                new WorkingDay { Id = 75, Start = new DateTime(2023, 02, 03, 09, 00, 00), End = new DateTime(2023, 02, 03, 17, 20, 00), RecordTypeId = 1, EmployeeId = 5 },
                new WorkingDay { Id = 76, Start = new DateTime(2023, 02, 06, 09, 00, 00), End = new DateTime(2023, 02, 06, 16, 39, 00), RecordTypeId = 1, EmployeeId = 5 },
                ...
                new WorkingDay { Id = 90, Start = new DateTime(2023, 02, 02, 09, 00, 00), End = new DateTime(2023, 02, 02, 17, 32, 00), RecordTypeId = 1, EmployeeId = 6 },
                new WorkingDay { Id = 91, Start = new DateTime(2023, 02, 03, 09, 00, 00), End = new DateTime(2023, 02, 03, 17, 40, 00), RecordTypeId = 1, EmployeeId = 6 },
                ...
                new WorkingDay { Id = 108, Start = new DateTime(2023, 02, 06, 09, 00, 00), End = new DateTime(2023, 02, 06, 17, 45, 00), RecordTypeId = 1, EmployeeId = 7 },
                new WorkingDay { Id = 109, Start = new DateTime(2023, 02, 07, 09, 00, 00), End = new DateTime(2023, 02, 07, 17, 30, 00), RecordTypeId = 1, EmployeeId = 7 },
                ...
                new WorkingDay { Id = 111, Start = new DateTime(2023, 02, 09, 09, 00, 00), End = new DateTime(2023, 02, 09, 17, 30, 00), RecordTypeId = 1, EmployeeId = 7 },
                ...
                new WorkingDay { Id = 119, Start = new DateTime(2023, 01, 30, 09, 00, 00), End = new DateTime(2023, 01, 30, 18, 10, 00), RecordTypeId = 1, EmployeeId = 8 },
                ...
                new WorkingDay { Id = 122, Start = new DateTime(2023, 02, 02, 09, 00, 00), End = new DateTime(2023, 02, 02, 15, 47, 00), RecordTypeId = 1, EmployeeId = 8 },
                new WorkingDay { Id = 123, Start = new DateTime(2023, 02, 03, 09, 00, 00), End = new DateTime(2023, 02, 03, 16, 30, 00), RecordTypeId = 1, EmployeeId = 8 },
                ...
                new WorkingDay { Id = 140, Start = new DateTime(2023, 02, 06, 09, 00, 00), End = new DateTime(2023, 02, 06, 18, 05, 00), RecordTypeId = 1, EmployeeId = 9 },
                new WorkingDay { Id = 141, Start = new DateTime(2023, 02, 07, 09, 00, 00), End = new DateTime(2023, 02, 07, 18, 20, 00), RecordTypeId = 1, EmployeeId = 9 },
                new WorkingDay { Id = 142, Start = new DateTime(2023, 02, 08, 09, 00, 00), End = new DateTime(2023, 02, 08, 17, 00, 00), RecordTypeId = 1, EmployeeId = 9 },
                ...
                new WorkingDay { Id = 156, Start = new DateTime(2023, 02, 06, 09, 00, 00), End = new DateTime(2023, 02, 06, 17, 15, 00), RecordTypeId = 1, EmployeeId = 10 },
                new WorkingDay { Id = 157, Start = new DateTime(2023, 02, 07, 09, 00, 00), End = new DateTime(2023, 02, 07, 17, 30, 00), RecordTypeId = 1, EmployeeId = 10 },
                new WorkingDay { Id = 158, Start = new DateTime(2023, 02, 08, 09, 00, 00), End = new DateTime(2023, 02, 08, 17, 45, 00), RecordTypeId = 1, EmployeeId = 10 },
